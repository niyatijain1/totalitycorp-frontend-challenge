...
import { decrementQuantity, deleteItem, incrementQuantity, resetCart } from '../redux/shopoholicsSlice'
            ...
            <div>
                {
                    productData.map((item) => (
                        <div key={item._id} className='flex items-center justify-between gap-6 mt-3'>
                            <div className='flex items-center gap-2'>
                                ...
                                <img className="w-32 object-cover" src={item.image} alt="productimage" />
                            </div>
                            ...
                            <div className='w-52 flex items-center justify-between text-gray-500 gap-4 border p-3'>
                                ...
                                <div className='flex items-center gap-4 text-sm font-semibold'>
                                    <span
                                        ...
                                        className='border h-5 font-normal text-lg flex items-center justify-center px-2 hover:bg-gray-700 hover:text-white cursor-pointer duration-300 active:ng-black'>-</span>
                                    {item.quantity}
                                    <span
                                        onClick={() =>
                                            dispatch(
