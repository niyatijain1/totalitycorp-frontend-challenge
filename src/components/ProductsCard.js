...
import { addToCart } from '../redux/shopoholicsSlice';
        ...
        <div className='flex justify-between items-center'>
          ...
          <div className='flex justify-end gap-2 relative overflow-hidden w-28 text-sm '>
            ...
            <p onClick={() => dispatch(addToCart({
              ...
              className='absolute z-20 w-[100px] text-black-500 hover:text-gray-900 flex items-center gap-1 top-0 transform -translate-x-32 group-hover:translate-x-0 transition-transform cursor-pointer duration-500'>Add to cart{" "} <span><BsArrowRight /></span></p>
          </div>
        </div>
        <div><p>
          {product.category}
